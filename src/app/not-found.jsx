...
export default function NotFound() {
  return (
    <div className="container mx-auto max-w-7xl flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
      ...
      {/* Navigation redirects back to Home page layout */}
      <Link href="/">
        <Button 
